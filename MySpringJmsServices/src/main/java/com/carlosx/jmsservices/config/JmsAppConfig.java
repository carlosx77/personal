package com.carlosx.jmsservices.config;
...
@Configuration
@EnableJms
@ComponentScan ("com.carlosx.jmsservices")
public class JmsAppConfig {
	...
	ConnectionFactory connectionFactory () {
		Map<String, Object> connDetails = new HashMap<String, Object>();
		connDetails.put(TransportConstants.HOST_PROP_NAME, "127.0.0.1");
		connDetails.put(TransportConstants.PORT_PROP_NAME, "5455");
