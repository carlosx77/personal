package com.carlosx.transactional.base.config;
...
public class XAJpaConfig {
	...
	public Properties hibernateProperties() {
		...
		hibernateProp.put("hibernate.transaction.factory_class", "org.hibernate.engine.transaction.internal.jta.CMTTransactionFactory");
	...
	public EntityManagerFactory emfA() {
		...
		factoryBean.setPackagesToScan("com.carlosx.transactional.base");
